class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.ducan = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'ducan').setOrigin(0, 1).setScale(0.6);
        this.banquo = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'banquo').setOrigin(0, 1).setScale(0.1);
        this.sirBalwin = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'sirBalwin').setOrigin(0, 1).setScale(0.6);
